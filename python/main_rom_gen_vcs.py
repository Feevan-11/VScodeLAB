...
def main00(mac_lenth = 20,mac_onece = 110):
    ...
    ethdma4_MM2S_sg_data = link_descriptors_in_memory(descriptors_ethdma_MM2S, base_addr=SGMEM_ETHDMA4_BASE+ETH3_S2MM_len, desc_size=64)
    ...
    with open(MAIN_TXT_file, 'w') as f0:
        ...
        f0.write("x7 0x"  + f"{(ETH3_S2MM_len + ETH_MM2S_len          & 0xFFFFFFFF):08x}"+"\n")
        f0.write("x8 0x"  + f"{(SGMEM_ETHDMA4_BASE    & 0xFFFFFFFF):08x}"+"\n")
        f0.write("x11 0x"  + f"{(ethdma3_config          & 0xFFFFFFFF):08x}"+"\n")
        f0.write("x12 0x"  + f"{(ethdma4_config          & 0xFFFFFFFF):08x}"+"\n")
        ...
        f0.write("x16 0x"  + f"{((SGMEM_ETHDMA3_BASE + ETH3_S2MM_len - 64)    & 0xFFFFFFFF):08x}"+"\n")
        f0.write("x17 0x"  + f"{((SGMEM_ETHDMA4_BASE + ETH3_S2MM_len)     & 0xFFFFFFFF):08x}"+"\n")
        f0.write("x18 0x"  + f"{((SGMEM_ETHDMA4_BASE + ETH3_S2MM_len + ETH_MM2S_len - 64)      & 0xFFFFFFFF):08x}"+"\n")
