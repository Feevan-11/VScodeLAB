...
| `0x0010` | `lui  x5, 0x00000`   | `lui  x6, 0xA0000`   | `lui  x7, 0x40000`   | `lui  x8, 0xB0001`     |
...
| `0x0060` | `addi x9, x9, 0x200` | `sw x7, 0x18(x2)`    | `sw x5, 0x18(x1)`    | `addi x10, x10, 0x800` |
...
| `0x00D0` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x1, 10`     |
| `0x00E0` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`       |
| `0x00F0` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.goto x1, 0xF10`    |
