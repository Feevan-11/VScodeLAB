...
| `0x0040` | `lui  x9, 0x00001`     | `sw x3,  0x0(x2)`      | `sw x3,  0x0(x1)`      | `lui  x10, 0x00001`    |
| `0x0050` | `addi x0, x0, 0`       | `sw x4, 0x4(x2)`       | `sw x4, 0x4(x1)`       | `addi x0, x0, 0`       |
| `0x0060` | `addi x9, x9, 0xFC0`   | `sw x7, 0x18(x2)`      | `sw x5, 0x18(x1)`      | `addi x10, x10, 0x800` |
...
| `0x00D0` | `lui  x11, 0x00001`    | `lui  x12, 0xAC000`    | `lui  x13, 0x00001`    | `lui  x14, 0x00002`    |
| `0x00E0` | `lui  x15, 0xA0000`    | `lui  x16, 0x00002`    | `lui  x17, 0x00004`    | `lui  x18, 0xA4000`    |
| `0x00F0` | `addi x11, x11, 0xFC0` | `addi x12, x12, 0x000` | `addi x13, x13, 0xFC0` | `addi x14, x14, 0xF80` |
| `0x0100` | `addi x15, x15, 0x000` | `addi x16, x16, 0x000` | `addi x17, x17, 0xF80` | `addi x18, x18, 0x000` |
...
| `0x02B0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  1000`  |
...
| `0x02F0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1, 50`     |
| `0x0300` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0310` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, 0xD20`    |
