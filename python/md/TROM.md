...
| `0x0060` | `addi x9, x9, 0x1C0`   | `sw x7, 0x18(x2)`      | `sw x5, 0x18(x1)`      | `addi x10, x10, 0x800` |
...
| `0x00E0` | `lui  x15, 0xA0000`    | `lui  x16, 0x00002`    | `lui  x17, 0x00002`    | `lui  x18, 0xA4000`    |
| `0x00F0` | `addi x11, x11, 0x1C0` | `addi x12, x12, 0x000` | `addi x13, x13, 0x1C0` | `addi x14, x14, 0x380` |
| `0x0100` | `addi x15, x15, 0x000` | `addi x16, x16, 0x000` | `addi x17, x17, 0x380` | `addi x18, x18, 0x000` |
| `0x0110` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x3, 0x4(x1)`       | `addi x0, x0, 0`       |
| `0x0120` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x4, 0x0(x1)`       | `addi x0, x0, 0`       |
...
| `0x0170` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  1000`  |
| `0x0180` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0190` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, -0x10`    |
| `0x01A0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x01B0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x3, 0x4(x1)`       | `addi x0, x0, 0`       |
| `0x01C0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x4, 0x0(x1)`       | `addi x0, x0, 0`       |
| `0x01D0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x14, 0x18(x1)`     | `addi x0, x0, 0`       |
| `0x01E0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x15, 0x20(x1)`     | `addi x0, x0, 0`       |
| `0x01F0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x16, 0x28(x1)`     | `addi x0, x0, 0`       |
| `0x0200` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0210` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  100`   |
| `0x0220` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x2,  100`   |
...
| `0x0260` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, -0x40`    |
| `0x0270` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0280` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x3, 0x4(x1)`       | `addi x0, x0, 0`       |
| `0x0290` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x4, 0x0(x1)`       | `addi x0, x0, 0`       |
| `0x02A0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x17, 0x18(x1)`     | `addi x0, x0, 0`       |
| `0x02B0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x18, 0x20(x1)`     | `addi x0, x0, 0`       |
| `0x02C0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x16, 0x28(x1)`     | `addi x0, x0, 0`       |
| `0x02D0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x02E0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  100`   |
| `0x02F0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x2,  100`   |
...
| `0x0330` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, -0x40`    |
| `0x0340` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0350` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1, 50`     |
| `0x0360` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0370` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, 0xCF0`    |
