...
| `0x0090` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  100`   |
...
| `0x0110` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x11, 0x18(x1)`     | `addi x0, x0, 0`       |
| `0x0120` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x12, 0x20(x1)`     | `addi x0, x0, 0`       |
| `0x0130` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x13, 0x28(x1)`     | `addi x0, x0, 0`       |
| `0x0140` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  100`   |
...
| `0x0180` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x14, 0x18(x1)`     | `addi x0, x0, 0`       |
| `0x0190` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x15, 0x20(x1)`     | `addi x0, x0, 0`       |
| `0x01A0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x16, 0x28(x1)`     | `addi x0, x0, 0`       |
| `0x01B0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  100`   |
| `0x01C0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x01D0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, -0x10`    |
| `0x01E0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x01F0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x17, 0x18(x1)`     | `addi x0, x0, 0`       |
| `0x0200` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x18, 0x20(x1)`     | `addi x0, x0, 0`       |
| `0x0210` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x16, 0x28(x1)`     | `addi x0, x0, 0`       |
| `0x0220` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  100`   |
| `0x0230` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0240` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, -0x10`    |
...
| `0x0280` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, 0xF10`    |
