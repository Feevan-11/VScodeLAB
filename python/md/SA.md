...
| `0x0030` | `addi x5, x5, 0x140` | `addi x6, x6, 0x140`  | `addi x7, x7, 0x140`  | `addi x8, x8, 0x140`  |
...
| `0x00C0` | `addi x0, x0, 0`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      | `lp.setup x1, 0x64`   |
...
| `0x0100` | `lui x1, 0xFF003`    | `lui x2, 0xFF003`     | `lui x3, 0xF6C00`     | `lui x4, 0xF7000`     |
| `0x0110` | `lui x5, 0x1`        | `lui x6, 0x1`         | `lui x7, 0xF6C00`     | `lui x8, 0xF7000`     |
| `0x0120` | `lui x9, 0xF6C00`    | `lui x10, 0xF7000`    | `lui x11, 0xF6C00`    | `lui x12, 0xF7000`    |
| `0x0130` | `addi x1, x1, 0x800` | `addi x2, x2, 0xC00`  | `addi x3, x3, 0x0`    | `addi x4, x4, 0x0`    |
| `0x0140` | `addi x5, x5, 0x1`   | `addi x6, x6, 0x0`    | `addi x7, x7, 0x0`    | `addi x8, x8, 0x0`    |
| `0x0150` | `addi x9, x9, 0x40`  | `addi x10, x10, 0x40` | `addi x11, x11, 0x40` | `addi x12, x12, 0x40` |
| `0x0160` | `addi x0, x0, 0`     | `sw x6, 0x34(x2)`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0170` | `addi x0, x0, 0`     | `sw x4,  0x38(x2)`    | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0180` | `addi x0, x0, 0`     | `sw x5, 0x30(x2)`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0190` | `addi x0, x0, 0`     | `sw x8, 0x40(x2)`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x01A0` | `addi x0, x0, 0`     | `sw x6, 0x34(x1)`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x01B0` | `addi x0, x0, 0`     | `sw x3,  0x38(x1)`    | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x01C0` | `addi x0, x0, 0`     | `sw x5, 0x30(x1)`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x01D0` | `addi x0, x0, 0`     | `sw x7, 0x40(x1)`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x01E0` | `addi x0, x0, 0`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      | `lp.setup x1, 0x64`   |
...
| `0x0220` | `addi x0, x0, 0`     | `sw x6, 0x4(x1)`      | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0230` | `addi x0, x0, 0`     | `sw x9,  0x8(x1)`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0240` | `addi x0, x0, 0`     | `sw x5, 0x0(x1)`      | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0250` | `addi x0, x0, 0`     | `sw x11, 0x10(x1)`    | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0260` | `addi x0, x0, 0`     | `sw x6, 0x4(x2)`      | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0270` | `addi x0, x0, 0`     | `sw x10,  0x8(x2)`    | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0280` | `addi x0, x0, 0`     | `sw x5, 0x0(x2)`      | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x0290` | `addi x0, x0, 0`     | `sw x12, 0x10(x2)`    | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x02A0` | `addi x0, x0, 0`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      | `lp.setup  x2, 100`   |
| `0x02B0` | `addi x0, x0, 0`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      | `addi x0, x0, 0`      |
| `0x02C0` | `addi x0, x0, 0`     | `addi x0, x0, 0`      | `addi x0, x0, 0`      | `lp.goto x1, -0x10`   |
