...
| `0x0010` | `lui x5, 0xA8000`    | `lui x6, 0xAC000`    | `lui x7, 0xA8001`    | `lui x8, 0xAC001`    |
| `0x0020` | `addi x1, x1, 0x800` | `addi x2, x2, 0x840` | `addi x3, x3, 0x8`   | `addi x4, x4, 0x0`   |
| `0x0030` | `addi x5, x5, 0x0`   | `addi x6, x6, 0x0`   | `addi x7, x7, 0xFC0` | `addi x8, x8, 0xFC0` |
...
| `0x0080` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x1, 1000` |
...
| `0x00D0` | `lui x5, 0x10001`    | `lui x6, 0x1`        | `lui x7, 0xA0040`    | `lui x8, 0xA4040`    |
| `0x00E0` | `addi x1, x1, 0x0`   | `addi x2, x2, 0x400` | `addi x3, x3, 0x0`   | `addi x4, x4, 0x0`   |
| `0x00F0` | `addi x5, x5, 0x1`   | `addi x6, x6, 0x0`   | `addi x7, x7, 0xFC0` | `addi x8, x8, 0xFC0` |
...
| `0x0140` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x1, 3`    |
...
| `0x0180` | `lui x1, 0xC0000`    | `lui x2, 0xC0000`    | `lui x3, 0xA0040`    | `lui x4, 0xA4040`    |
| `0x0190` | `lui x5, 0x10001`    | `lui x6, 0x1`        | `lui x7, 0xA0080`    | `lui x8, 0xA4080`    |
| `0x01A0` | `addi x1, x1, 0x0`   | `addi x2, x2, 0x400` | `addi x3, x3, 0x0`   | `addi x4, x4, 0x0`   |
| `0x01B0` | `addi x5, x5, 0x1`   | `addi x6, x6, 0x0`   | `addi x7, x7, 0xFC0` | `addi x8, x8, 0xFC0` |
...
| `0x0200` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x1, 100`  |
