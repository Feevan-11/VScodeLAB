...
| `0x0030` | `addi x5, x5, 0x0`   | `addi x6, x6, 0x200` | `addi x7, x7, 0x1C0` | `addi x8, x8, 0x3C0` |
...
| `0x0080` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup x1, 0x1`   |
| `0x0090` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x2,  100` |
...
| `0x00F0` | `lui x1, 0xC0000`    | `lui x2, 0xC0000`    | `lui x3, 0xA0000`    | `lui x4, 0xA0002`    |
| `0x0100` | `lui x5, 0x1`        | `lui x6, 0x1`        | `lui x7, 0xA0001`    | `lui x8, 0xA0003`    |
| `0x0110` | `addi x1, x1, 0x0`   | `addi x2, x2, 0x400` | `addi x3, x3, 0x400` | `addi x4, x4, 0x400` |
| `0x0120` | `addi x5, x5, 0x1`   | `addi x6, x6, 0x0`   | `addi x7, x7, 0x3C0` | `addi x8, x8, 0x3C0` |
| `0x0130` | `addi x0, x0, 0`     | `sw x4,  0x38(x2)`   | `sw x3,  0x38(x1)`   | `addi x0, x0, 0`     |
| `0x0140` | `addi x0, x0, 0`     | `sw x5, 0x30(x2)`    | `sw x5, 0x30(x1)`    | `addi x0, x0, 0`     |
| `0x0150` | `addi x0, x0, 0`     | `sw x6, 0x34(x2)`    | `sw x6, 0x34(x1)`    | `addi x0, x0, 0`     |
| `0x0160` | `addi x0, x0, 0`     | `sw x8, 0x40(x2)`    | `sw x7, 0x40(x1)`    | `addi x0, x0, 0`     |
| `0x0170` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup x1, 0x0`   |
...
| `0x01B0` | `lui x1, 0xC0000`    | `lui x2, 0xC0000`    | `lui x3, 0xA0001`    | `lui x4, 0xA0003`    |
| `0x01C0` | `lui x5, 0x1`        | `lui x6, 0x1`        | `lui x7, 0xA0002`    | `lui x8, 0xA0004`    |
| `0x01D0` | `addi x1, x1, 0x0`   | `addi x2, x2, 0x400` | `addi x3, x3, 0x400` | `addi x4, x4, 0x400` |
| `0x01E0` | `addi x5, x5, 0x1`   | `addi x6, x6, 0x0`   | `addi x7, x7, 0x3C0` | `addi x8, x8, 0x3C0` |
| `0x01F0` | `addi x0, x0, 0`     | `sw x4,  0x8(x2)`    | `sw x3,  0x8(x1)`    | `addi x0, x0, 0`     |
| `0x0200` | `addi x0, x0, 0`     | `sw x5, 0x0(x2)`     | `sw x5, 0x0(x1)`     | `addi x0, x0, 0`     |
| `0x0210` | `addi x0, x0, 0`     | `sw x6, 0x4(x2)`     | `sw x6, 0x4(x1)`     | `addi x0, x0, 0`     |
| `0x0220` | `addi x0, x0, 0`     | `sw x8, 0x10(x2)`    | `sw x7, 0x10(x1)`    | `addi x0, x0, 0`     |
| `0x0230` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup x1, 0xE`   |
| `0x0240` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x2,  100` |
...
| `0x0280` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.goto x1, -0x40`  |
