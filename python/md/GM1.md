...
| `0x0100` | `lui x1, 0xFF003`    | `lui x2, 0xFF003`    | `lui x3, 0xF5400`    | `lui x4, 0xF5600`    |
| `0x0110` | `lui x5, 0x11`       | `lui x6, 0x1`        | `lui x7, 0xF5400`    | `lui x8, 0xF5600`    |
| `0x0120` | `lui x11, 0xF5400`   | `lui x12, 0xF5600`   | `lui x13, 0xF5400`   | `lui x14, 0xF5600`   |
