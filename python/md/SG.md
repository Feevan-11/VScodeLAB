...
| `0x0010` | `lui x5, 0x40000`      | `lui x6, 0xF4000`     | `lui x7, 0x0`          | `lui x8, 0x40000`      |
| `0x0020` | `addi x1, x1, 0x400`   | `addi x2, x2, 0x440`  | `addi x3, x3, 0x0`     | `addi x4, x4, 0x0`     |
| `0x0030` | `addi x5, x5, 0x780`   | `addi x6, x6, 0x140`  | `addi x7, x7, 0x40`    | `addi x8, x8, 0x7C0`   |
| `0x0040` | `lui x9, 0xF4200`      | `lui x10, 0x0`        | `sw x3,  0x0(x1)`      | `addi x0, x0, 0`       |
| `0x0050` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0060` | `addi x9, x9, 0x140`   | `addi x10, x10, 0x40` | `sw x4, 0x4(x1)`       | `addi x0, x0, 0`       |
...
| `0x00A0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x3,  0x0(x2)`      | `addi x0, x0, 0`       |
| `0x00B0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x4, 0x4(x2)`       | `addi x0, x0, 0`       |
| `0x00C0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x8, 0x18(x2)`      | `addi x0, x0, 0`       |
| `0x00D0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x9, 0x20(x2)`      | `addi x0, x0, 0`       |
| `0x00E0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x10, 0x28(x2)`     | `addi x0, x0, 0`       |
| `0x00F0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`       | `lp.setup x1, 0x65`    |
...
| `0x0130` | `lui x11, 0x40001`     | `lui x12, 0xF6C00`    | `lui x13, 0x0`         | `lui x14, 0x40001`     |
| `0x0140` | `lui x15, 0xF7000`     | `lui x16, 0x0`        | `lui  x17, 0x00002`    | `lui  x18, 0xA4000`    |
| `0x0150` | `addi x11, x11, 0x800` | `addi x12, x12, 0x0`  | `addi x13, x13, 0x80`  | `addi x14, x14, 0x880` |
| `0x0160` | `addi x15, x15, 0x0`   | `addi x16, x16, 0x80` | `addi x17, x17, 0x380` | `addi x18, x18, 0x000` |
...
| `0x01D0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x3, 0x4(x2)`       | `addi x0, x0, 0`       |
| `0x01E0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x4, 0x0(x2)`       | `addi x0, x0, 0`       |
| `0x01F0` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x14, 0x18(x2)`     | `addi x0, x0, 0`       |
| `0x0200` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `sw x15, 0x20(x2)`     | `addi x0, x0, 0`       |
...
| `0x0240` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`       | `lp.setup  x2,  2`     |
...
| `0x0280` | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`       | `lp.goto x3, -0x40`    |
