...
| `0x0020` | `addi x1, x1, 0x0` | `addi x2, x2, 0x200` | `addi x3, x3, 0x1` | `addi x4, x4, 0x2`  |
...
| `0x0070` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `beq x9, x3, 0xD0`  |
| `0x0080` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `addi x0, x0, 0`    |
| `0x0090` | `addi x0, x0, 0`   | `add x1, x1, x2`     | `addi x0, x0, 0`   | `addi x0, x0, 0`    |
| `0x00A0` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `addi x0, x0, 0`    |
| `0x00B0` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `beq x9, x4, 0xD0`  |
...
| `0x00F0` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `lp.goto x1, -0xA0` |
| `0x0100` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `addi x0, x0, 0`    |
| `0x0110` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `addi x0, x0, 0`    |
| `0x0120` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `lp.goto x2, 0xA0`  |
| `0x0130` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `addi x0, x0, 0`    |
| `0x0140` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `lp.setup x2, 0x0`  |
| `0x0150` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `add x5, x5, x3`   | `addi x0, x0, 0`    |
| `0x0160` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `lp.goto x2, -0xA0` |
| `0x0170` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `addi x0, x0, 0`    |
| `0x0180` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `lp.setup x2, 0x0`  |
| `0x0190` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `add x6, x6, x4`   | `addi x0, x0, 0`    |
| `0x01A0` | `addi x0, x0, 0`   | `addi x0, x0, 0`     | `addi x0, x0, 0`   | `lp.goto x2, -0xA0` |
