...
| `0x0010` | `lui x5, 0xF7400`    | `lui x6, 0xF7402`      | `lui x7, 0xF7602`     | `lui x8, 0xF7603`    |
| `0x0020` | `addi x1, x1, 0x0`   | `addi x2, x2, 0x400`   | `addi x3, x3, 0x1`    | `addi x4, x4, 0x0`   |
| `0x0030` | `addi x5, x5, 0x0`   | `addi x6, x6, 0x8C0`   | `addi x7, x7, 0x900`  | `addi x8, x8, 0x1C0` |
| `0x0040` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0050` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x4, 0x34(x2)`     | `addi x0, x0, 0`     |
| `0x0060` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x5,  0x38(x2)`    | `addi x0, x0, 0`     |
| `0x0070` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x3, 0x30(x2)`     | `addi x0, x0, 0`     |
| `0x0080` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x6, 0x40(x2)`     | `addi x0, x0, 0`     |
| `0x0090` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x4, 0x4(x1)`      | `addi x0, x0, 0`     |
| `0x00A0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x7,  0x8(x1)`     | `addi x0, x0, 0`     |
| `0x00B0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x3, 0x0(x1)`      | `addi x0, x0, 0`     |
| `0x00C0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x8, 0x10(x1)`     | `addi x0, x0, 0`     |
| `0x00D0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x00E0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x00F0` | `lui x1, 0x40000`    | `lui x2, 0x0`          | `lui x3, 0x0`         | `lui x4, 0x0`        |
| `0x0100` | `lui x5, 0x0`        | `lui x6, 0x0`          | `lui x7, 0x40001`     | `lui x8, 0x0`        |
| `0x0110` | `lui x15, 0x80000`   | `lui x16, 0x21C68`     | `lui x17, 0x0`        | `lui x18, 0x0`       |
| `0x0120` | `addi x1, x1, 0x0`   | `addi x2, x2, 0x40`    | `addi x3, x3, 0x1`    | `addi x4, x4, 0x2`   |
| `0x0130` | `addi x5, x5, 0x0`   | `addi x6, x6, 0x0`     | `addi x7, x7, 0x695`  | `addi x8, x8, 0xFFF` |
| `0x0140` | `addi x15, x15, 0x0` | `addi x16, x16, 0x450` | `addi x17, x17, 0x1B` | `addi x18, x18, 0x0` |
| `0x0150` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0160` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x1, 0x10`  |
| `0x0170` | `lw x10, 0xD(x7)`    | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
...
| `0x01D0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `beq x10, x8, 0x60`  |
...
| `0x0240` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x1, 0x10`  |
| `0x0250` | `lw x9, 0xD(x1)`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
...
| `0x02A0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `beq x9, x3, 0x110`  |
...
| `0x02F0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `beq x9, x4, 0x100`  |
...
| `0x0340` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `add x1, x1, x2`     |
| `0x0350` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0360` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x1, -0x110` |
| `0x0370` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0380` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0390` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x2, 0xA0`   |
| `0x03A0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x03B0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x2, 100`   |
| `0x03C0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `add x5, x5, x3`      | `addi x0, x0, 0`     |
| `0x03D0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x2, -0x110` |
| `0x03E0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x03F0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x2, 100`   |
| `0x0400` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `add x6, x6, x4`      | `addi x0, x0, 0`     |
| `0x0410` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x2, -0x100` |
...
| `0x0470` | `sw x16, 0x0(x15)`   | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0480` | `sw x17, 0x4(x15)`   | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0490` | `sw x5, 0xE(x15)`    | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x04A0` | `sw x6, 0x16(x15)`   | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x04B0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x2, 0x30`  |
| `0x04C0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x04D0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x2, -0x10`  |
