...
| `0x0050` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x4, 0x4(x1)`      | `addi x0, x0, 0`     |
| `0x0060` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x5,  0x8(x1)`     | `addi x0, x0, 0`     |
| `0x0070` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x3, 0x0(x1)`      | `addi x0, x0, 0`     |
| `0x0080` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `sw x6, 0x10(x1)`     | `addi x0, x0, 0`     |
...
| `0x02A0` | `lui x1, 0x40000`    | `lui x2, 0x0`          | `lui x3, 0x0`         | `lui x4, 0x0`        |
| `0x02B0` | `lui x5, 0x0`        | `lui x6, 0x0`          | `lui x7, 0x40001`     | `lui x8, 0x0`        |
| `0x02C0` | `lui x15, 0x80000`   | `lui x16, 0x21C68`     | `lui x17, 0x0`        | `lui x18, 0x0`       |
| `0x02D0` | `addi x1, x1, 0x0`   | `addi x2, x2, 0x40`    | `addi x3, x3, 0x1`    | `addi x4, x4, 0x2`   |
| `0x02E0` | `addi x5, x5, 0x0`   | `addi x6, x6, 0x0`     | `addi x7, x7, 0x695`  | `addi x8, x8, 0x0`   |
| `0x02F0` | `addi x15, x15, 0x0` | `addi x16, x16, 0x450` | `addi x17, x17, 0x1B` | `addi x18, x18, 0x0` |
| `0x0300` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0310` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x1, 0x10`  |
| `0x0320` | `lw x10, 0xD(x7)`    | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0330` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x2, 0x10`  |
...
| `0x0380` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `beq x10, x8, 0x60`  |
...
| `0x03D0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x1, -0xC0`  |
| `0x03E0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x03F0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x1, 0x10`  |
| `0x0400` | `lw x9, 0xD(x1)`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
...
| `0x0450` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `beq x9, x3, 0x110`  |
...
| `0x04A0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `beq x9, x4, 0x100`  |
...
| `0x04F0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `add x1, x1, x2`     |
| `0x0500` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0510` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x1, -0x110` |
| `0x0520` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0530` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0540` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x2, 0xA0`   |
| `0x0550` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0560` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x2, 100`   |
| `0x0570` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `add x5, x5, x3`      | `addi x0, x0, 0`     |
| `0x0580` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x2, -0x110` |
| `0x0590` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x05A0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x2, 100`   |
| `0x05B0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `add x6, x6, x4`      | `addi x0, x0, 0`     |
| `0x05C0` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.goto x2, -0x100` |
...
| `0x0620` | `sw x16, 0x0(x15)`   | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0630` | `sw x17, 0x4(x15)`   | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0640` | `sw x5, 0xE(x15)`    | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0650` | `sw x6, 0x16(x15)`   | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `addi x0, x0, 0`     |
| `0x0660` | `addi x0, x0, 0`     | `addi x0, x0, 0`       | `addi x0, x0, 0`      | `lp.setup x2, 0x30`  |
