...
| `0x0080` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x1, 10`     |
...
| `0x0200` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x1, 10`     |
...
| `0x0250` | `lui  x5, 0x84000`   | `lui  x6, 0x00000`   | `lui  x7, 0x8C000`   | `lui  x8, 0x68000`     |
...
| `0x02D0` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x1, 10`     |
