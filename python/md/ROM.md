...
| `0x0210` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  1000`  |
...
| `0x0250` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x3, 0x4(x1)`       | `addi x0, x0, 0`       |
| `0x0260` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x4, 0x0(x1)`       | `addi x0, x0, 0`       |
| `0x0270` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x17, 0x18(x1)`     | `addi x0, x0, 0`       |
| `0x0280` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x18, 0x20(x1)`     | `addi x0, x0, 0`       |
| `0x0290` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `sw x16, 0x28(x1)`     | `addi x0, x0, 0`       |
| `0x02A0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x02B0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1,  100`   |
| `0x02C0` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x2,  100`   |
...
| `0x0300` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, -0x40`    |
| `0x0310` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0320` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.setup  x1, 50`     |
| `0x0330` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       |
| `0x0340` | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, 0xCF0`    |
