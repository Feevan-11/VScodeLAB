...
| `0x0040` | `lui x9, 0x1`        | `sw x3,  0x0(x2)`    | `sw x3,  0x0(x1)`    | `lui x10, 0x1`       |
| `0x0050` | `addi x0, x0, 0`     | `sw x4, 0x4(x2)`     | `sw x4, 0x4(x1)`     | `addi x0, x0, 0`     |
| `0x0060` | `addi x9, x9, 0x200` | `sw x7, 0x18(x2)`    | `sw x5, 0x18(x1)`    | `addi x10, x10, 0x0` |
...
| `0x0090` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup x1, 0x70`  |
