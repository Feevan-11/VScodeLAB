...
| `0x0060` | `addi x9, x9, 0x80`   | `addi x10, x10, 0x800` | `sw x4, 0x4(x2)`       | `addi x0, x0, 0`       |
...
| `0x0140` | `lui x15, 0xF4400`    | `lui x16, 0x0`         | `lui x17, 0x40000`     | `lui x18, 0xF4800`     |
| `0x0150` | `addi x11, x11, 0x80` | `addi x12, x12, 0x0`   | `addi x13, x13, 0x80`  | `addi x14, x14, 0x100` |
| `0x0160` | `addi x15, x15, 0x0`  | `addi x16, x16, 0x200` | `addi x17, x17, 0x300` | `addi x18, x18, 0x0`   |
