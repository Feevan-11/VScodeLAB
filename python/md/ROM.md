...
| `0x0010` | `lui x5, 0x0`         | `lui x6, 0xA8000`      | `lui x7, 0x40000`      | `lui x8, 0xB0001`      |
...
| `0x0040` | `lui x9, 0x0`         | `sw x3,  0x0(x2)`      | `sw x3,  0x0(x1)`      | `lui x10, 0x1`         |
...
| `0x00D0` | `lui x11, 0x0`        | `lui x12, 0xAC000`     | `lui x13, 0x0`         | `lui x14, 0x0`         |
| `0x00E0` | `lui x15, 0xA0000`    | `lui x16, 0x0`         | `lui x17, 0x0`         | `lui x18, 0xA4000`     |
| `0x00F0` | `addi x11, x11, 0x40` | `addi x12, x12, 0x0`   | `addi x13, x13, 0x40`  | `addi x14, x14, 0x80`  |
| `0x0100` | `addi x15, x15, 0x0`  | `addi x16, x16, 0x200` | `addi x17, x17, 0x280` | `addi x18, x18, 0x0`   |
...
| `0x0310` | `addi x0, x0, 0`      | `addi x0, x0, 0`       | `addi x0, x0, 0`       | `lp.goto x1, 0xCF0`    |
