...
| `0x0020` | `lui x1, 0xFF006`    | `lui x2, 0xFF010`    | `lui x3, 0xFF020`    | `lui x4, 0xFF030`    |
...
| `0x0070` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `sw x2,  0x4(x1)`    | `addi x0, x0, 0`     |
| `0x0080` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `sw x3,  0x4(x1)`    | `addi x0, x0, 0`     |
| `0x0090` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `sw x4, 0x4(x1)`     | `addi x0, x0, 0`     |
| `0x00A0` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `sw x5, 0x4(x1)`     | `addi x0, x0, 0`     |
...
| `0x0100` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lw x10, 0x8(x1)`    | `addi x0, x0, 0`     |
| `0x0110` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x1, 50`   |
| `0x0120` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.setup  x2, 10`   |
| `0x0130` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     |
| `0x0140` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.goto x2, -0x10`  |
| `0x0150` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     |
| `0x0160` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.goto x1, -0x40`  |
| `0x0170` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     |
| `0x0180` | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `addi x0, x0, 0`     | `lp.goto x3, -0x170` |
